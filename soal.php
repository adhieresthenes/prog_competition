...
<body>
	...
	<div id="container">
		<div id="content">
			<div id="box">
				<h2><img src="images/last.gif" alt="ad"> Soal Programming Contest</h2>
				<p>
					<ul>
						<li><a href="soal1">Soal 1</a></li>
						<li><a href="soal2">Soal 2</a></li>
						<li><a href="soal3">Soal 3</a></li>
						<li><a href="soal4">Soal 4</a></li>
						<li><a href="soal5">Soal 5</a></li>
						<li><a href="soal6">Soal 6</a></li>
						<li><a href="soal7">Soal 7</a></li>
						<li><a href="soal8">Soal 8</a></li>
						<li><a href="soal9">Soal 9</a></li>
						<li><a href="soal10">Soal 10</a></li>
					</ul>
				</p>
			</div>
		</div>
